...
const DEFAULT_HOMEPAGE: HomepageSettings = {
  ...
  steps: [
    ...
    { title: "Подготовка", text: "Прививки, документы и приучение к лотку." },
...
const DEFAULT_FAQ: FaqSettings = {
  ...
  items: [
    ...
    },
    {
      ...
      a: "Обычно с 3 месяцев — после необходимых прививок, приучения к лотку и базовой социализации. Так малыш переезжает здоровым и готовым к новой семье.",
