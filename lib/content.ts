...
const DEFAULT_HOMEPAGE: HomepageSettings = {
  ...
  steps: [
    ...
    { title: "Подготовка", text: "Прививки по возрасту и оформление документов." },
...
const DEFAULT_FAQ: FaqSettings = {
  ...
  items: [
    ...
    },
    {
      ...
      a: "Метрика (родословная), ветеринарный паспорт с прививками по возрасту и договор купли-продажи.",
      category: "Бронь и оплата",
    },
    {
      q: "В каком возрасте котята переезжают в новый дом?",
      a: "Обычно с 3 месяцев — после необходимых прививок и базовой социализации. Так малыш переезжает здоровым и готовым к новой семье.",
