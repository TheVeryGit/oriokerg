  ...
  return (
    <div className="mx-auto flex w-full max-w-7xl flex-col gap-10 px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
      <section className="rounded-[2rem] border border-border bg-card p-8 sm:p-10">
        ...
        <div
          className="mt-6 max-w-3xl space-y-5 text-base leading-8 text-muted [&_h1]:text-3xl [&_h1]:font-semibold [&_h1]:text-foreground [&_h2]:text-2xl [&_h2]:font-semibold [&_h2]:text-foreground [&_p]:mb-5 [&_ul]:mb-5 [&_ul]:list-disc [&_ul]:pl-6"
